...
const list_available_30_minute_slots_multiple_person_1 = require("./list-available-30-minute-slots-multiple-person");
describe(`05 - ${list_available_30_minute_slots_multiple_person_1.listAvailable30MinuteSlotsMultiplePerson.name}`, () => {
    const availabilityA = {
        include: [
            {
    ...
    it('should return available slots between 9 and 13 Monday', () => {
        ...
        const result = (0, list_available_30_minute_slots_multiple_person_1.listAvailable30MinuteSlotsMultiplePerson)([
