...
const list_available_30_minute_slots_1 = require("./list-available-30-minute-slots");
describe(`04 - ${list_available_30_minute_slots_1.listAvailable30MinuteSlots.name}`, () => {
    const availability = {
        include: [
            {
    ...
    it('should return available slots between 9 and 13 Monday', () => {
        ...
        const result = (0, list_available_30_minute_slots_1.listAvailable30MinuteSlots)(availability, events, [startDate, endDate]);
